...
To install xray-connector from **Renault** npm repository
...
$ export ARTIFACTORY_TOKEN=<an artifactory token, generated from your artifactory profile page>
```

*Note*: you can log in to artifactory [here](https://artifactory.dt.renault.com/artifactory/). Use SAML SSO to log in.
You can generate a token from your profile page.

 * Run the following command

```bash
$ curl -u $ARTIFACTORY_USERNAME:$ARTIFACTORY_TOKEN https://artifactory.dt.renault.com/artifactory/api/npm/npm-renault/auth/rd | sed "s/:443//g"
```
